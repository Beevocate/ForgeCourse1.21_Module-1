...
public class BloodDemonEntity extends Monster implements Enemy {
    ...
    // BOSS HEALTH BAR % DOES NOT UPDATE TO CURRENT HEALTH
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes().add(Attributes.MAX_HEALTH, 100D).add(Attributes.FOLLOW_RANGE, 35.0).add(Attributes.MOVEMENT_SPEED, 0.36).add(Attributes.ATTACK_DAMAGE, 3.0).add(Attributes.ARMOR, 2.0);
    }
