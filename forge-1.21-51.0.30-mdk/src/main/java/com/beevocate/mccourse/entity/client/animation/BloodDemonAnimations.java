package com.beevocate.mccourse.entity.client.animation;
...
public class BloodDemonAnimations {
    ...
    public static final AnimationDefinition attack = AnimationDefinition.Builder.withLength(0.5f).looping()
            .addAnimation("leftarm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.125F, KeyframeAnimations.degreeVec(-37.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
